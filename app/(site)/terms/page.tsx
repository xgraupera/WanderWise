    ...
    <>
      ...
      <main className="p-8 bg-gray-50 min-h-screen text-center space-y-8">
        ...
        <section className="max-w-3xl mx-auto text-gray-700 leading-relaxed space-y-4 text-justify">
          <p>
            Welcome to WanderWisely. By accessing or using our platform, you agree to these Terms and
          ...
          <p>
            WanderWisely provides travel planning and budgeting tools for personal use. You agree not
          ...
          <p>
            WanderWisely is provided “as is.” While we strive for accuracy, we do not guarantee that
          ...
          <p>
            We may update these Terms from time to time. Continued use of WanderWisely after changes
